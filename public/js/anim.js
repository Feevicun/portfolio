...
const sticksAnimation = anime.timeline({
  ...
  update: () => console.log(sticksAnimation.progress),
...
const welcomeAnimation = anime.timeline({
    autoplay: false,
  });
  welcomeAnimation
  .add({
    targets: '.stagger-visualizer div',
    opacity: 0, // Fade out the sticks
    duration: 500, // Adjust as needed
    easing: 'easeOutQuad'
  });

  // Play the welcome animation first
  sticksAnimation.play();

// Play sticks animation after the welcome animation completes
sticksAnimation.finished.then(() => {
